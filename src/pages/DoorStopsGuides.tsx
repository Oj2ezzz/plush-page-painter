...
const DoorStopsGuides = () => {
  const products = [
    { title: "DS1 Silver", image: ds1Silver },
    { title: "DS1 Black", image: ds1Black },
    { title: "DSA Aluminum", image: dsaAluminum },
    { title: "DSG Glass", image: dsgGlass },
    { title: "DG1 Silver", image: dg1Silver },
    { title: "DG1 Black", image: dg1Black }
  ];
      ...
      <section className="pt-52 pb-24 bg-background">
        <div className="container mx-auto px-6">
          <div className="text-center mb-20">
            <h1 className="text-5xl md:text-6xl font-bold text-foreground mb-8">Door Stops & Guides</h1>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">Protective and functional door stops and guides for every application</p>
          </div>
