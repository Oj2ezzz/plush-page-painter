          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none text-muted-foreground space-y-8">
              <section>
                ...
                <p>By accessing and using MMR Hardware's website and services, you accept and agree to be bound by the terms and provision of this agreement. If you do not agree to abide by the above, please do not use this service.</p>
              </section>

              <section>
                <h2 className="text-3xl font-bold text-foreground mb-4">2. Description of Service</h2>
                <p>MMR Hardware provides architectural hardware solutions including custom manufacturing, design consultation, and premium hardware products for commercial and residential applications. Our services include but are not limited to product design, manufacturing, sales, and customer support.</p>
              </section>

              <section>
                <h2 className="text-3xl font-bold text-foreground mb-4">3. User Accounts and Registration</h2>
                <p className="mb-4">When you create an account with us or provide information for quotes and services:</p>
              ...
              <section>
                ...
                <p className="mb-4">When placing orders or requesting quotes:</p>
                <ul className="list-disc pl-6 space-y-2 mb-4">
              ...
              <section>
                ...
                <p className="mb-4">Product warranties and return policies:</p>
                <ul className="list-disc pl-6 space-y-2 mb-4">
              ...
              <section>
                ...
                <p className="mb-4">All content on this website and our products are protected by intellectual property laws:</p>
                <ul className="list-disc pl-6 space-y-2 mb-4">
              ...
              <section>
                ...
                <p>To the fullest extent permitted by applicable law, MMR Hardware shall not be liable for any indirect, incidental, special, consequential, or punitive damages, or any loss of profits or revenues, whether incurred directly or indirectly, or any loss of data, use, goodwill, or other intangible losses resulting from your use of our services or products.</p>
              </section>

              <section>
                <h2 className="text-3xl font-bold text-foreground mb-4">9. Indemnification</h2>
                <p>You agree to defend, indemnify, and hold harmless MMR Hardware and its affiliates, officers, directors, employees, and agents from and against any claims, damages, obligations, losses, liabilities, costs, or debt, and expenses (including but not limited to attorney's fees) arising from your use of our services or violation of these terms.</p>
              </section>

              <section>
                <h2 className="text-3xl font-bold text-foreground mb-4">10. Force Majeure</h2>
                <p>MMR Hardware shall not be liable for any failure or delay in performance due to circumstances beyond our reasonable control, including but not limited to acts of God, natural disasters, war, terrorism, labor disputes, or government actions.</p>
              </section>

              <section>
                <h2 className="text-3xl font-bold text-foreground mb-4">11. Governing Law</h2>
                <p>These Terms shall be interpreted and governed by the laws of Ontario, Canada, without regard to its conflict of law provisions. Any disputes arising from these terms shall be resolved in the courts of Ontario, Canada.</p>
              </section>

              <section>
                <h2 className="text-3xl font-bold text-foreground mb-4">12. Modifications to Terms</h2>
                <p>We reserve the right to modify these Terms of Service at any time. We will notify users of significant changes by posting the updated terms on our website and updating the "Last updated" date. Your continued use of our services after such modifications constitutes acceptance of the updated terms.</p>
              </section>
              ...
              <section>
                ...
                <div className="bg-secondary p-6 rounded-xl border border-border">
                  <p><strong className="text-foreground">MMR Hardware</strong></p>
                  <p>266 Rutherford Rd S, Unit 18</p>
                  <p>Brampton, ON, Canada</p>
                  <p>Phone: <a href="tel:+16475617045" className="text-foreground hover:underline">647-561-7045</a></p>
                  <p>Email: <a href="mailto:Michael@MMRHardware.com" className="text-foreground hover:underline">Michael@MMRHardware.com</a></p>
                </div>
              </section>
            </div>
          </div>
